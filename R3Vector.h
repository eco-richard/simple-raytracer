...
class R3Vector {
  public:
    ...
    R3Vector(const R3Vector& rhs) noexcept = default; 
    R3Vector(R3Vector&& rhs) noexcept = default; 
    R3Vector& operator=(const R3Vector& rhs) noexcept = default;
    R3Vector& operator=(R3Vector&& rhs) noexcept = default;
